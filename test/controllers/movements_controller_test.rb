...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { amount: @movement.amount, bill_id: @movement.bill_id, date: @movement.date, description: @movement.description, movement_type: @movement.movement_type, time: @movement.time, user_id: @movement.user_id } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { amount: @movement.amount, bill_id: @movement.bill_id, date: @movement.date, description: @movement.description, movement_type: @movement.movement_type, time: @movement.time, user_id: @movement.user_id } }
